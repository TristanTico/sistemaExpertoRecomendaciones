...
<!-- Services-->
    ...
    <section class="page-section bg-light" id="portfolio">
        <div class="container" style="background-color: #333366">
            <div class="text-center">
                <h2 class="section-heading text-uppercase">Ciudades</h2>
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        <div class="portfolio-item">
                            ...
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">{{ $ciudad->nombre }}</div>
                                <div class="portfolio-caption-subheading text-muted">{{ $ciudad->categoria }}</div>
                            </div>
                        </div>
    ...
    @foreach ($ciudades as $ciudad)
    <div class="portfolio-modal modal fade" id="portfolioModal{{ $ciudad->id }}" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" style="max-width: 500px;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <img class="img-fluid" src="data:image/jpeg;base64,{{ base64_encode($ciudad->imagen) }}" alt="{{ $ciudad->nombre }}" />
